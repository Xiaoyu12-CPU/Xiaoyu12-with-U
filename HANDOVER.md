...
- 当前开发版本：`v0.4.6.1`
- 最新完整发布版本：`v0.4.5.1`
- 最新 Windows x64 修复版：`v0.4.5.2`
- 正式代码分支：`main`
- 日常开发分支：`develop`
- 当前开发分支：`codex/v0.4.6.1`
- 版本变化：[CHANGELOG.md](./CHANGELOG.md)
- 架构说明：[ARCHITECTURE.md](./ARCHITECTURE.md)

`main` 与 `develop` 当前仍停留在 `v0.4.5.1`；`v0.4.5.2` 是单独发布的 Windows x64 拖动状态修复。`codex/v0.4.6.1` 基于 v0.4.6 本地开发提交，包含该修复、控制中心外观主题功能以及主题数据模型修正。旧发布标签只作为历史快照保留，不应复用或移动。
...
3. 验收完成后创建新的不可移动标签 `v0.4.6.1`，不要复用或移动已经公开的旧标签。
